...
def save_val_bbox(path, dir):
    ...
    for p in batched_preds:
        ...
        img = Image.open(f'datasets/drones_clean/images/{p}{ext}')
...
if __name__ == '__main__':
    ...
    model.cuda()
    model.val(data='drones_relabel.yaml', batch=16, imgsz=1024, conf=0.1, plots=True, save_json=True, workers=4)
    exit()
